...
int main() {
	...
	size_t dim = 16; // 16 electron, 8 electron pairs
	size_t nob = 8;
	double eps = 10e-12;
	size_t start_rank = 2;
	size_t max_rank = 20;
...
//							for (size_t b3 = 0; b3 < 2; b3++){
//								for (size_t b4 = 0; b4 < 2; b4++){
//									if (b1 == b2 && b3 == b4){
//										auto i_2 = 2*i+b1;
//										auto j_2 = 2*j+b2;
//										auto k_2 = 2*k+b3;
//										auto l_2 = 2*l+b4;
//										auto s12_deg = (i_2 == j_2) ? 2.0 : 1.0;
//										auto s34_deg = (k_2 == l_2) ? 2.0 : 1.0;
//										auto s12_34_deg = (i_2 == k_2) ? (j_2 == l_2 ? 2.0 : 1.0) : 1.0;
//										auto s1234_deg = s12_deg * s34_deg * s12_34_deg;
//										value_t val_ijkl = (0.5) * V[{i, j, k, l}] * 1 / s1234_deg;
//										std::cout <<  i_2 << j_2 << k_2 << l_2 << " " << s1234_deg << std::endl;
//
//										opV += val_ijkl * return_two_e_ac(i_2,k_2,l_2,j_2,d);
//										opV += val_ijkl * return_two_e_ac(l_2,k_2,i_2,j_2,d);
//										opV += val_ijkl * return_two_e_ac(i_2,j_2,l_2,k_2,d);
//										opV += val_ijkl * return_two_e_ac(l_2,j_2,i_2,k_2,d);
//										opV += val_ijkl * return_two_e_ac(k_2,i_2,j_2,l_2,d);
//										opV += val_ijkl * return_two_e_ac(j_2,i_2,k_2,l_2,d);
//										opV += val_ijkl * return_two_e_ac(k_2,l_2,j_2,i_2,d);
//										opV += val_ijkl * return_two_e_ac(j_2,l_2,k_2,i_2,d);
//									}
//
//					count++;
//				}}}}}
...
//	phi.round(10e-14);
	...
	XERUS_LOG(info, "The ev error is  " << std::abs(-14.37016558404629 - lambda) );
